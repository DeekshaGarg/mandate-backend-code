...
public class EmpController {
	...
	/*
	 * @GetMapping("/empDetails/{id}") public ResponseEntity<EmpModel>
	 * get(@PathVariable Integer id) { try { EmpModel emp = service.get(id); return
	 * new ResponseEntity<EmpModel>(emp, HttpStatus.OK); } catch
	 * (NoSuchElementException e) { return new
	 * ResponseEntity<EmpModel>(HttpStatus.NOT_FOUND); } }
	 */
}
